...
class AracKiralamaUygulamasi:
    ...
    def musteri_giris(self):
        ...
        # Kullanıcıyı veritabanına ekle ve kullanıcı kimliğini al
        musteri_id = self.musteri_ekle(ad_soyad)
        if musteri_id:
    ...
    def musteri_ekle(self, ad_soyad):
        # Kullanıcıyı veritabanına ekle ve kimliği döndür
    ...
    def arac_kirala(self):
        ...
        if selected_item:
            ...
            if kiralama_tipi:
                sure = self.kiralama_sure_goster(kiralama_tipi)
    ...
    def kiralama_sure_goster(self, kiralama_tip):
        while True:
